import {FootballCamp, Session, Overview, Details, Organizer, Contact} from './football-camp';
...
bourgBlanc.contacts = [
  new Contact()
    ...
    .withLastname('Le Hir')
    .withPhoneNumber('06.XX.XX.XX.XX')
    .withPathToPicture('./assets/img/bourg-blanc/organizers/avatar/Stephane-LE-HIR.jpg'),
  new Contact()
    .withFirstname('Germain')
    .withLastname('Biannic')
    .withPhoneNumber('07.XX.XX.XX.XX')
    .withPathToPicture('./assets/img/bourg-blanc/organizers/avatar/Germain-BIANNIC.jpg')
];
