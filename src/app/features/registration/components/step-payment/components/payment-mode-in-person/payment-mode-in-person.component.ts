...
@Component({
  selector: 'app-payment-mode-in-person',
  templateUrl: './payment-mode-in-person.component.html',
  styleUrls: ['./payment-mode-in-person.component.scss']
})
export class PaymentModeInPersonComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    console.log('PaymentModeInPersonComponent.ngOnChanges()');
  ...
  ngOnInit(): void {
    console.log('PaymentModeInPersonComponent.ngOnInit()');
