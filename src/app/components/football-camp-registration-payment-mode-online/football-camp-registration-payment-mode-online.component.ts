...
@Component({
  ...
  templateUrl: './football-camp-registration-payment-mode-online.component.html',
  styleUrls: ['./football-camp-registration-payment-mode-online.component.scss']
})
export class FootballCampRegistrationPaymentModeOnlineComponent implements OnInit, OnChanges {
